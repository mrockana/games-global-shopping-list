...
public sealed class DeleteShoppingItemCommandHandler : IApplicationRequestHandler<DeleteShoppingItemCommand, DeleteShoppingItemResponse>
{
    ...
    public DeleteShoppingItemCommandHandler(IApplicationRepository repository, ILogger<DeleteShoppingItemCommandHandler> logger)
    {
...
public sealed record DeleteShoppingItemCommand(long ShoppingItemId)
